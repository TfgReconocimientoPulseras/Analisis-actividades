...
X = genfromtxt("../Datos/DAtos_train/movil/X_train_movil_aplaudirfinal.csv", delimiter=',')
y = genfromtxt("../Datos/DAtos_train/movil/y_train_movil_aplaudirfinal.csv", delimiter='')
