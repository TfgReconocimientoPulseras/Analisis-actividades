...
X_train= genfromtxt("X_train_movil2.csv", delimiter=',')
y_train= genfromtxt("y_train_movil2.csv", delimiter='')
X_train[np.isnan(X_train)] = np.median(X_train[~np.isnan(X_train)])
X_val= genfromtxt("X_val_movil2.csv", delimiter=',')
y_val= genfromtxt("y_val_movil2.csv", delimiter='')
X_val[np.isnan(X_val)] = np.median(X_val[~np.isnan(X_val)])


x = min_samples_split = [0.001, 0.01, 0.025, 0.1, 0.2, 0.5, 50, 25, 10]
split_len = len(min_samples_split)
y = min_samples_leaf = [0.001, 0.01, 0.025, 0.1, 0.2, 0.5, 50, 25, 10]
